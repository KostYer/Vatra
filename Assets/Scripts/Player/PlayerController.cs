...
namespace Player
{
    public class PlayerController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            var _hInput = Input.GetAxis("Horizontal");
        ...
        private void Move()
        {
            ...
            var currentHorizontalSpeed = new Vector3(_controller.velocity.x, 0.0f, 0.0f).magnitude;

            var speedOffset = 0.1f;
            var inputMagnitude = 1f; //Mathf.Abs(Input.GetAxis("Horizontal"))  ;
            ...
            var inputDirection = new Vector3(hInput, 0.0f, 0f).normalized;
            if (hInput != 0f)
            {
            ...
            var targetDirection = Quaternion.Euler(0.0f, _targetRotation, 0.0f) * Vector3.right;
